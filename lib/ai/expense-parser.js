...
1. WHO PAID (PAYER DETECTION):
   - If text mentions someone else paid (e.g. "Harsh has paid bill for Dhruv", "Harsh paid $50", "Alice paid for dinner", "Harsh ne diya", "Harsh ne pay kiya", "Harsh ne bhara"):
...
3. MULTILINGUAL & HINGLISH / CODE-MIXED SUPPORT:
   - Understand Hindi / Hinglish / Romanized code-mixed phrases seamlessly:
     ...
     * Exact phrasing: "Harsh ka 200 baaki mera" -> Harsh owes 200, current user owes remaining.
...
Example 1: "Bhai CCD pe 450 bill aaya, maine pay kiya Harsh aur mere beech aadha aadha split kar"
{
  ...
  "splits": [
    ...
    { "userId": "user_id_of_harsh", "amount": 225.0, "paid": false }
  ],
  "reasoning": "CCD bill of 450 paid by Dhruv, split equally between Dhruv and Harsh (225 each)",
  "confidence": 0.95
}

Example 2: "Uber gaadi mein 300 gaya, Harsh ne pay kiya mera aur uska 50-50"
{
  "type": "expense_proposal",
  "description": "Uber",
  "amount": 300.0,
  ...
  "date": ${Date.now()},
  "paidByUserId": "user_id_of_harsh",
  "groupId": null,
  "splitType": "equal",
  "splits": [
    { "userId": "user_id_of_harsh", "amount": 150.0, "paid": true },
    { "userId": "${currentUser.id}", "amount": 150.0, "paid": false }
  ],
  "reasoning": "Uber ride 300 paid by Harsh, split 50-50 with Dhruv (150 each)",
  "confidence": 0.95
}
