...
6. AMBIGUITY: Only return Type 3 ("clarification_needed") if participants are completely missing or no amount can be found anywhere in the text or receipt.
7. ARITHMETIC: In Type 1 ("expense_proposal"), splits must sum up exactly to the total amount.
