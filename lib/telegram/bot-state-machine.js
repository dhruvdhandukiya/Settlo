...
• _"Dinner with Alex $60, I paid"_
• _"Bhai CCD pe 450 bill aaya, maine pay kiya Alex aur mera aadha aadha"_
...
Please generate the complete expense proposal.`;
    ...
    await sendTelegramMessage(
      chatId,
      "Could not understand expense. Please try phrasing like: 'Dinner with Alex $50, I paid' or send a receipt photo."
    );
  } catch (err) {
...
📊 View on dashboard: ${process.env.NEXT_PUBLIC_APP_URL || "https://settlo.app"}/dashboard`
    ...
    await sendTelegramMessage(
      chatId,
      "ℹ️ No pending expense proposal to confirm. Send a message like: 'Dinner with Alex $60, I paid' to create one!"
    );
  }
}
